...
def OTA_UpdateFirmware(info):
  ...
  info.script.AppendExtra('package_extract_file("firmware-update/keymaster64.mbn", "/dev/block/bootdevice/by-name/keymaster");')
  info.script.AppendExtra('package_extract_file("firmware-update/logfs_ufs_8mb.bin", "/dev/block/bootdevice/by-name/logfs");')
  info.script.AppendExtra('package_extract_file("firmware-update/pmic.elf", "/dev/block/bootdevice/by-name/pmic");')
  ...
  info.script.AppendExtra('package_extract_file("firmware-update/keymaster64.mbn", "/dev/block/bootdevice/by-name/keymasterbak");')
  info.script.AppendExtra('package_extract_file("firmware-update/pmic.elf", "/dev/block/bootdevice/by-name/pmicbak");')
